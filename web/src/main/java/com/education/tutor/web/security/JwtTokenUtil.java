...
public class JwtTokenUtil implements Serializable {
	...
	public String generateToken(UserDetails userDetails, Device device) {
		...
		claims.put(CLAIM_KEY_ISSUEDAT, now);
		claims.put(CLAIM_KEY_EXPIRATION, now + expiration);
	...
	public String generateToken(Map<String, Object> claims) {
		...
		return Jwts.builder().setExpiration(generateExpirationDate()).setIssuedAt(new Date())
				.setSubject((String) claims.get(CLAIM_KEY_USERNAME)).setIssuer("OILUP")
